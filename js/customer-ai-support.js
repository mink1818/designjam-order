...
const rules=[
 ...
 {keys:['주소 변경','주소변경','사업장 주소','주소 바꾸','주소 수정'],answer:'환경설정의 개인정보 변경에서 주소 검색을 눌러 도로명·구주소(지번)·건물명으로 검색한 뒤 주소를 선택하고 상세주소를 입력해 저장하세요. 변경된 주소는 이후 새 주문의 기본정보에 사용됩니다.',link:'customer-settings.html'},
 ...
 {keys:['안녕','사용법','뭘 물어'],answer:'안녕하세요. 주문수정, 배송·송장, 품절, 입금계좌, 로그인, 주소변경, 앱 설치, 상품검색 등을 물어보세요.'}
];

...
function loadAuthenticatedAdminChrome(){
  ...
  ['js/session-status.js?v=65960','js/admin-mobile-nav.js?v=65960'].forEach(src=>{const script=document.createElement('script');script.src=src;script.defer=true;document.body.appendChild(script)});
}

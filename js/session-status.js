(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      #designjamDesktopBrowserControls{position:fixed;top:10px;left:132px;z-index:2147483000;display:flex;align-items:center;gap:4px;padding:0;background:transparent;font-family:Arial,sans-serif}#designjamDesktopBrowserControls button{min-width:0;height:32px;padding:6px 9px;border:1px solid rgba(255,255,255,.42);border-radius:999px;background:rgba(14,52,105,.92);color:#fff;font-size:12px;line-height:1;font-weight:800;box-shadow:0 3px 10px rgba(0,0,0,.15);cursor:pointer}#designjamDesktopBrowserControls button:hover{background:#0f3f7d}#designjamDesktopBrowserControls button:active{transform:translateY(1px)}
...
// V6.5.46: 관리자·거래처 PC 화면 공통 브라우저 이동 버튼

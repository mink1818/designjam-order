(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      #designjamSessionStatus.session-status{position:fixed!important;top:10px!important;right:10px!important;left:auto!important;z-index:2147483647!important;display:flex!important;visibility:visible!important;opacity:1!important;align-items:center!important;gap:8px!important;max-width:calc(100vw - 20px)!important;padding:8px 9px 8px 11px!important;border:1px solid rgba(255,255,255,.20)!important;border-radius:14px!important;background:rgba(23,43,77,.20)!important;backdrop-filter:blur(7px)!important;-webkit-backdrop-filter:blur(7px)!important;color:#fff!important;box-shadow:0 6px 18px rgba(0,0,0,.16)!important;font-family:Arial,sans-serif!important;transform:none!important}
      #designjamSessionStatus.session-status-customer{background:rgba(36,88,159,.18)!important}
      ...
      #designjamSessionStatus .session-status-action{flex:0 0 auto!important;padding:7px 9px!important;border:0!important;border-radius:9px!important;background:rgba(255,255,255,.08)!important;color:#fff!important;font-size:12px!important;font-weight:700!important;cursor:pointer!important}

(() => {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      #designjamDesktopBrowserControls{position:fixed;top:62px;left:14px;z-index:2147483000;display:flex;gap:6px;padding:6px;border:1px solid #cbd7e5;border-radius:13px;background:rgba(255,255,255,.96);box-shadow:0 5px 16px rgba(20,45,75,.16);font-family:Arial,sans-serif}#designjamDesktopBrowserControls button{min-width:74px;padding:9px 11px;border:1px solid #c8d4e2;border-radius:9px;background:#fff;color:#173a63;font-size:13px;font-weight:800;cursor:pointer}#designjamDesktopBrowserControls button:hover{background:#eaf3ff}#designjamDesktopBrowserControls button:active{transform:translateY(1px)}
...
// V6.5.45: 관리자·거래처 PC 화면 공통 브라우저 이동 버튼

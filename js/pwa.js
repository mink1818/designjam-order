(function(){
  ...
  const icon=app==='admin'?'/icons/admin-192.png?v=65350':'/icons/customer-192.png?v=65350';
        ...
        <div class="ds-guide-body">
          <div class="ds-device-guide" data-guide="android">
            ...
            <div class="ds-full-guide-image">
              <img src="/images/install-guide/android-full-guide.jpg?v=65350" alt="디자인 삭스 홈 화면 추가 전체 안내" loading="eager" decoding="async" data-guide-image>
            </div>
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if('serviceWorker'in navigator){
      ...
      navigator.serviceWorker.register('/service-worker.js?v=65350').then(reg=>{
        reg.update();

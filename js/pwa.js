(function(){
        ...
        <div class="ds-guide-body">
          <div class="ds-device-guide" data-guide="android">
            ...
            <div class="ds-full-guide-image">
              <img src="images/install-guide/android-full-guide.png?v=5334" alt="디자인삭스 홈 화면 추가 전체 안내" data-guide-image>
            </div>
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if('serviceWorker'in navigator){
      navigator.serviceWorker.register('/service-worker.js?v=5334').then(reg=>reg.update()).catch(console.warn);
    }
  });
})();

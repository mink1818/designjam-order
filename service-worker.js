const CACHE_NAME='design-socks-v6-6-8-picking-shipping-b1';
const APP_SHELL=[
  '/offline.html?v=66090',
  '/css/main.css?v=66090',
  '/css/admin.css?v=66090',
  '/css/statement.css?v=66040',
  '/customer-share-document.html?v=66090',
  '/css/customer-share-document.css?v=66040',
  '/js/customer-share-document.js?v=66090',
  '/js/pwa.js?v=66040',
  '/js/version-badge.js?v=66090',
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith(
    fetch(req,{cache:'no-store'}).then(res=>{
      ...
      if(req.mode==='navigate') return caches.match('/offline.html?v=66090');
